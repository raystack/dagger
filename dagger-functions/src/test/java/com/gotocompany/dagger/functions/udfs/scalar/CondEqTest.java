...
public class CondEqTest {
    ...
    public void shouldHandleFieldNameEmpty() {
        thrown.expectMessage("Key :  does not exist in Message com.gotocompany.dagger.consumer.TestBookingLogMessage");
    ...
    public void shouldHandleFieldNameDoesNotExist() {
        thrown.expectMessage("Key : arbitrary does not exist in Message com.gotocompany.dagger.consumer.TestBookingLogMessage");
        thrown.expect(LongbowException.class);
        TestBookingLogMessage testBookingLog = TestBookingLogMessage.newBuilder().build();
