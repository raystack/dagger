...
public class SelectFieldsTest {
    ...
    public void shouldReturnSelectedValues() throws Exception {
        ...
        Object[] selectedFields = selectFields.eval(byteStrings, "com.gotocompany.dagger.consumer.TestBookingLogMessage", "order_number");
    ...
    public void shouldThrowErrorWhenFieldNameDoesNotMatch() throws Exception {
        ...
        thrown.expectMessage("Key : order_number_ does not exist in Message com.gotocompany.dagger.consumer.TestBookingLogMessage");
        ...
        selectFields.open(functionContext);
        selectFields.eval(byteStrings, "com.gotocompany.dagger.consumer.TestBookingLogMessage", "order_number_");
    }
    ...
    public void shouldReturnSelectedValueForNestedFieldsInCaseOfSelectOnly() throws Exception {
        ...
        Object[] selectedFields = selectFields.eval(byteStrings,
                "com.gotocompany.dagger.consumer.TestEnrichedBookingLogMessage",
    ...
    public void shouldThrowIfNoParentClassFound() throws Exception {
        ...
        selectFields.open(functionContext);
        selectFields.eval(byteStrings, "com.gotocompany.dagger.consumer.NotTestBookingLogMessage", "order_number");
    }
