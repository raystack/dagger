...
public class ElementTest {
    ...
    public void shouldInitializeValueElementWhenNotMessageType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("com.gotocompany.dagger.consumer.TestBookingLogMessage")), "service_type");
    ...
    public void shouldInitializeRowElementWhenNotMessageType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("com.gotocompany.dagger.consumer.TestBookingLogMessage")), "routes");
    ...
    public void shouldHandleInvalidType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("com.gotocompany.dagger.consumer.TestBookingLogMessage")), "invalid");
