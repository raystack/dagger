...
public class FiltersTest {
    ...
    public void shouldReturnEverythingFromInputWhenPredicateIsTrue()
        ...
        List<DynamicMessage> result = filter.eval(inputBytes, "com.gotocompany.dagger.consumer.TestBookingLogMessage", alwaysTrue);
    ...
    public void shouldReturnNothingFromInputWhenPredicateIsFalse()
        ...
        Filters filter = new Filters(StencilClientFactory.getClient());
        List<DynamicMessage> result = filter.eval(inputBytes, "com.gotocompany.dagger.consumer.TestBookingLogMessage", alwaysFalse);
    ...
    public void shouldReturnOnlyWhenPredicateIsTrue()
        ...
        Filters filter = new Filters(StencilClientFactory.getClient());
        List<DynamicMessage> result = filter.eval(inputBytes, "com.gotocompany.dagger.consumer.TestBookingLogMessage", predicate);
    ...
    public void shouldAcceptTwoPredicates() throws ClassNotFoundException, InvalidProtocolBufferException {
        ...
        Filters filter = new Filters(StencilClientFactory.getClient());
        List<DynamicMessage> result = filter.eval(inputBytes, "com.gotocompany.dagger.consumer.TestBookingLogMessage", alwaysTrue, predicate);
    ...
    public void shouldNotTestAgainstNextPredicateWhenFailEarly() throws ClassNotFoundException, InvalidProtocolBufferException {
        ...
        Filters filter = new Filters(StencilClientFactory.getClient());
        List<DynamicMessage> result = filter.eval(inputBytes, "com.gotocompany.dagger.consumer.TestBookingLogMessage", alwaysTrue, predicate, alwaysTrue);
