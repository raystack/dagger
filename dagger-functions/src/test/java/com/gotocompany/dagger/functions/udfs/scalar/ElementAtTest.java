...
public class ElementAtTest {
    ...
    public void setup() {
        ...
        protos.put("data_stream_0", "com.gotocompany.dagger.consumer.TestBookingLogMessage");
        protos.put("data_stream_1", "com.gotocompany.dagger.consumer.TestCustomerLogMessage");
        when(stencilClientOrchestrator.getStencilClient()).thenReturn(stencilClient);
        when(stencilClient.get("com.gotocompany.dagger.consumer.TestBookingLogMessage")).thenReturn(TestBookingLogMessage.getDescriptor());
    ...
    public void shouldReturnElementOfArrayForGivenTableNameAtGivenIndexAndPath() throws Exception {
        protos = new LinkedHashMap<>();
        protos.put("data_stream_0", "com.gotocompany.dagger.consumer.TestCustomerLogMessage");
        protos.put("booking", "com.gotocompany.dagger.consumer.TestBookingLogMessage");
