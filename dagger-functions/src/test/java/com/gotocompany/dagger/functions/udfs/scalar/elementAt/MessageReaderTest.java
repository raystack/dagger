...
public class MessageReaderTest {
    ...
    public void shouldBeAbleToReadPathOfOneDepth() throws ClassNotFoundException {
        ...
        MessageReader messageReader = new MessageReader(routeRow, "com.gotocompany.dagger.consumer.TestBookingLogMessage", "routes", STENCIL_CLIENT);
    ...
    public void shouldHandleWhenNoValidProtobufForMessageRoute() throws ClassNotFoundException {
        ...
        MessageReader messageReader = new MessageReader(routeRow, "com.gotocompany.dagger.consumer.TestBookingLogMessage", "invalid", STENCIL_CLIENT);
