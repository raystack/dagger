package org.raystack.dagger.functions.udfs.scalar.elementAt;
...
public class MessageReaderTest {
    ...
    public void shouldBeAbleToReadPathOfOneDepth() throws ClassNotFoundException {
        ...
        MessageReader messageReader = new MessageReader(routeRow, "org.raystack.dagger.consumer.TestBookingLogMessage", "routes", STENCIL_CLIENT);
    ...
    public void shouldHandleWhenNoValidProtobufForMessageRoute() throws ClassNotFoundException {
        ...
        MessageReader messageReader = new MessageReader(routeRow, "org.raystack.dagger.consumer.TestBookingLogMessage", "invalid", STENCIL_CLIENT);
