...
public class ElementAtTest {
    ...
    public void setup() {
        ...
        protos.put("data_stream_0", "org.raystack.dagger.consumer.TestBookingLogMessage");
        protos.put("data_stream_1", "org.raystack.dagger.consumer.TestCustomerLogMessage");
        when(stencilClientOrchestrator.getStencilClient()).thenReturn(stencilClient);
        when(stencilClient.get("org.raystack.dagger.consumer.TestBookingLogMessage")).thenReturn(TestBookingLogMessage.getDescriptor());
    ...
    public void shouldReturnElementOfArrayForGivenTableNameAtGivenIndexAndPath() throws Exception {
        protos = new LinkedHashMap<>();
        protos.put("data_stream_0", "org.raystack.dagger.consumer.TestCustomerLogMessage");
        protos.put("booking", "org.raystack.dagger.consumer.TestBookingLogMessage");
