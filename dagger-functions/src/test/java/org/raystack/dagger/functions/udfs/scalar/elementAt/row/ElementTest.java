package org.raystack.dagger.functions.udfs.scalar.elementAt.row;

import com.google.protobuf.Descriptors;
import org.raystack.dagger.functions.udfs.scalar.elementAt.descriptor.CustomDescriptor;
...
public class ElementTest {
    ...
    public void shouldInitializeValueElementWhenNotMessageType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("org.raystack.dagger.consumer.TestBookingLogMessage")), "service_type");
    ...
    public void shouldInitializeRowElementWhenNotMessageType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("org.raystack.dagger.consumer.TestBookingLogMessage")), "routes");
    ...
    public void shouldHandleInvalidType() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Optional<Element> element = Element.initialize(null, null, new CustomDescriptor(getDescriptor("org.raystack.dagger.consumer.TestBookingLogMessage")), "invalid");
