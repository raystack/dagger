...
public class ESAsyncConnectorDeprecated extends RichAsyncFunction<Row, Row> {
    ...
    public ESAsyncConnectorDeprecated(Integer fieldIndex, Map<String, String> configuration, StencilClient stencilClient) {
        this.fieldIndex = fieldIndex;
        this.configuration = configuration;
        this.stencilClient = stencilClient;
    }

    ESAsyncConnectorDeprecated(Integer fieldIndex, Map<String, String> configuration, StencilClient stencilClient, RestClient esClient) {
        this.fieldIndex = fieldIndex;
        this.configuration = configuration;
        this.stencilClient = stencilClient;
    ...
    public void asyncInvoke(Row input, ResultFuture<Row> resultFuture) {
        ...
        EsResponseHandlerDeprecated esResponseHandler = new EsResponseHandlerDeprecated(input, resultFuture, descriptor, fieldIndex, statsManager);
