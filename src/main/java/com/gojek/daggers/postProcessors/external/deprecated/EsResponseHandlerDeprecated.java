...
public class EsResponseHandlerDeprecated implements ResponseListener {
    private Row input;
    ...
    public EsResponseHandlerDeprecated(Row input, ResultFuture<Row> resultFuture, Descriptor descriptor, Integer fieldIndex, StatsManager statsManager) {
        this.input = input;
