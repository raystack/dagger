...
//        ProtoSerializer protoSerializer = new ProtoSerializer(outputProtoKey, protoClassName, columnNames, stencilClientOrchestrator, outputTopic);
...
//        ProtoSerializer protoSerializer = new ProtoSerializer(outputProtoKey, protoClassNamePrefix, columnNames, stencilClientOrchestrator, outputTopic);
//        long seconds = System.currentTimeMillis() / 1000;
//
...
//
//        String[] columnNames = {};
//        ProtoSerializer protoSerializer = new ProtoSerializer(null, null, columnNames, stencilClientOrchestrator, outputTopic);
//    }
//
//    @Test
...
//        ProtoSerializer protoSerializer = new ProtoSerializer(outputProtoKey, null, columnNames,
