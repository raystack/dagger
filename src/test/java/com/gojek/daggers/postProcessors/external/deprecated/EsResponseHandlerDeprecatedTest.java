...
public class EsResponseHandlerDeprecatedTest {
    ...
    private Row input;
    private Row value;
    private EsResponseHandlerDeprecated esResponseHandler;
    ...
    public void setUp() throws Exception {
        ...
        esResponseHandler = new EsResponseHandlerDeprecated(input, resultFuture, descriptor, 0, statsManager);
