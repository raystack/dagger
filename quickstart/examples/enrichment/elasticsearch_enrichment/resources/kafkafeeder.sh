...
protoc --proto_path=com/gotocompany/dagger/consumer/ --encode=com.gotocompany.dagger.consumer.TestBookingLogMessage com/gotocompany/dagger/consumer/TestLogMessage.proto > message.bin
