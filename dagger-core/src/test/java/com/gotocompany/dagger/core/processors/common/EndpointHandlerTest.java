...
import com.gotocompany.dagger.consumer.TestEnumType;
...
public class EndpointHandlerTest {
    ...
    public void setup() {
        ...
        inputProtoClasses = new String[]{"com.gotocompany.dagger.consumer.TestBookingLogMessage"};
    ...
    public void shouldReturnEndpointQueryVariableValuesForPrimitiveDataFromDescriptorInCaseOfMultipleStreams() {
        when(sourceConfig.getVariables()).thenReturn("customer_id");
        inputProtoClasses = new String[]{"com.gotocompany.dagger.consumer.TestBookingLogMessage", "com.gotocompany.dagger.consumer.TestBookingLogMessage"};
    ...
    public void shouldThrowErrorIfInputProtoNotFound() {
        when(sourceConfig.getVariables()).thenReturn("driver_pickup_location");
        inputProtoClasses = new String[]{"com.gotocompany.dagger.consumer.TestBookingLogMessage1"};
