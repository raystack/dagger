...
public class TransformConfigTest {
    ...
    @Before
    public void setUp() {
        transformationClass = "com.gotocompany.daggers.postprocessor.XTransformer";
    ...
    public void shouldReturnTransformationClass() {
        assertEquals("com.gotocompany.daggers.postprocessor.XTransformer", defaultTransformConfig.getTransformationClass());
    }
    ...
    public void shouldReturnMandatoryFields() {
        ...
        expectedMandatoryFields.put("transformationClass", "com.gotocompany.daggers.postprocessor.XTransformer");
    ...
    public void shouldThrowExceptionIfDefaultFieldsAreOverridden() {
        TransformConfig config = new TransformConfig("com.gotocompany.TestClass", new HashMap<String, Object>() {{
