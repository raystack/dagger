...
public class PgAsyncConnectorTest {
    ...
    public void setUp() {
        ...
        inputProtoClasses = new String[]{"com.gotocompany.consumer.TestLogMessage"};
        ...
        when(schemaConfig.getOutputProtoClassName()).thenReturn("com.gotocompany.consumer.TestBookingLogMessage");
    ...
    private PgSourceConfigBuilder getPgSourceConfigBuilder() {
        return new PgSourceConfigBuilder()
                ...
                .setDatabase("db")
                .setType("com.gotocompany.consumer.TestFlattenLogMessage")
                .setCapacity("30")
    ...
    public void shouldFetchDescriptorInInvoke() throws Exception {
        ...
        verify(stencilClient, times(1)).get("com.gotocompany.consumer.TestFlattenLogMessage");
    }
    ...
    public void shouldCompleteExceptionallyIfDescriptorNotFound() throws Exception {
        ...
        assertEquals("No Descriptor found for class com.gotocompany.consumer.TestLogMessage", reportFatalExceptionCaptor.getValue().getMessage());
        ...
        assertEquals("No Descriptor found for class com.gotocompany.consumer.TestLogMessage", decriptorNotFoundCaptor.getValue().getMessage());
    }
    ...
    public void shouldEnrichWhenQueryVariableFieldIsNullOrRemovedButNotRequiredInPattern() throws Exception {
        ...
        verify(resultFuture, times(1)).completeExceptionally(invalidConfigCaptor.capture());
        assertEquals("No Descriptor found for class com.gotocompany.consumer.TestFlattenLogMessage",
                invalidConfigCaptor.getValue().getMessage());
    ...
    public void shouldNotEnrichOutputOnTimeout() throws Exception {
        ...
        verify(meterStatsManager, times(1)).markEvent(ExternalSourceAspects.TIMEOUTS);
    ...
    public void shouldGetDescriptorFromOutputProtoIfTypeNotGiven() throws Exception {
        ...
        pgAsyncConnector.open(configuration);
        pgAsyncConnector.asyncInvoke(streamRow, resultFuture);
        verify(stencilClient, times(1)).get("com.gotocompany.consumer.TestBookingLogMessage");
    }
