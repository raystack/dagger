...
import org.raystack.dagger.common.serde.typehandler.RowFactory;
...
public class JsonPayloadFunctionTest {
    ...
    public void setup() throws InvalidProtocolBufferException {
        initMocks(this);
        commonInternalSourceConfig = getInternalSourceConfigForProtoClass("org.raystack.dagger.consumer.TestBookingLogMessage");

        commonSchemaConfig = getSchemaConfigForProtoAndDescriptor("org.raystack.dagger.consumer.TestBookingLogMessage", TestBookingLogMessage.getDescriptor());
    ...
    public void shouldGetCorrectJsonPayloadForStringFields() throws InvalidProtocolBufferException {
        String protoClass = "org.raystack.dagger.consumer.TestMessage";
    ...
    public void shouldGetCorrectJsonPayloadForRepeatedFields() throws InvalidProtocolBufferException {
        String protoClass = "org.raystack.dagger.consumer.TestNestedRepeatedMessage";
        InternalSourceConfig internalSourceConfig = getInternalSourceConfigForProtoClass(protoClass);
    ...
    public void shouldGetCorrectJsonPayloadForMapFields() throws InvalidProtocolBufferException {
        String protoClass = "org.raystack.dagger.consumer.TestMapMessage";
        InternalSourceConfig internalSourceConfig = getInternalSourceConfigForProtoClass(protoClass);
    ...
    public void shouldGetCorrectJsonPayloadForComplexFields() throws InvalidProtocolBufferException {
        String protoClass = "org.raystack.dagger.consumer.TestComplexMap";
        InternalSourceConfig internalSourceConfig = getInternalSourceConfigForProtoClass(protoClass);
