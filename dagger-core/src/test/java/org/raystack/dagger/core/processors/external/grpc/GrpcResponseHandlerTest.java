package org.raystack.dagger.core.processors.external.grpc;

import com.google.protobuf.Descriptors;
import com.google.protobuf.DynamicMessage;
import com.google.protobuf.InvalidProtocolBufferException;
import org.raystack.dagger.core.exception.GrpcFailureException;
...
import org.raystack.dagger.consumer.TestLocation;
...
public class GrpcResponseHandlerTest {
    ...
    public void setup() {
        ...
        grpcSourceConfig = new GrpcSourceConfigBuilder().setEndpoint("localhost").setServicePort(5000).setGrpcRequestProtoSchema("org.raystack.dagger.consumer.TestGrpcRequest").setGrpcResponseProtoSchema("org.raystack.dagger.consumer.GrpcResponse").setGrpcMethodUrl("org.raystack.dagger.consumer.test/TestMethod").setRequestPattern("{\"key\": \"%s\"}").setRequestVariables("customer_id").setOutputMapping(outputMapping).createGrpcSourceConfig();
    }
    ...
    public void shouldDetectProperBodyAndHandleResponseIfRetainResponseTypeIsFalse() throws InvalidProtocolBufferException {
        ...
        grpcSourceConfig = new GrpcSourceConfigBuilder().setEndpoint("localhost").setServicePort(8000).setGrpcRequestProtoSchema("org.raystack.dagger.consumer.TestGrpcRequest").setGrpcResponseProtoSchema("org.raystack.dagger.consumer.TestGrpcResponse").setGrpcMethodUrl("org.raystack.dagger.consumer.test/TestMethod").setRequestPattern("{\"key\": \"%s\"}").setRequestVariables("customer_id").setOutputMapping(outputMapping).createGrpcSourceConfig();

        grpcSourceConfig.setType("org.raystack.dagger.consumer.TestGrpcResponse");
    ...
    public void shouldDetectProperBodyAndHandleResponseIfRetainResponseTypeIsFalseANdTypeHasDifferentDatType() throws InvalidProtocolBufferException {
        ...
        grpcSourceConfig.setType("org.raystack.dagger.consumer.TestAggregatedSupplyMessage");
    ...
    public void shouldDetectExceptionIfMessageIsWrong() throws InvalidProtocolBufferException {
        ...
        grpcSourceConfig = new GrpcSourceConfigBuilder()
                .setGrpcRequestProtoSchema("org.raystack.dagger.consumer.TestGrpcRequest")
                .setGrpcResponseProtoSchema("org.raystack.dagger.consumer.de.meta.WrongGrpcResponse")
                .setGrpcMethodUrl("org.raystack.dagger.consumer.test/TestMethod")
