...
import org.raystack.dagger.consumer.TestEnumType;
...
import org.raystack.dagger.core.processors.types.SourceConfig;
...
public class EndpointHandlerTest {
    ...
    public void setup() {
        ...
        inputProtoClasses = new String[]{"org.raystack.dagger.consumer.TestBookingLogMessage"};
    ...
    public void shouldReturnEndpointQueryVariableValuesForPrimitiveDataFromDescriptor() {
        ...
        Object[] endpointOrQueryVariablesValues = endpointHandler
                .getVariablesValue(rowManager, Constants.ExternalPostProcessorVariableType.REQUEST_VARIABLES, sourceConfig.getVariables(), resultFuture);
    ...
    public void shouldReturnJsonValueOfEndpointQueryValuesIncaseOfComplexDatatype() {
        ...
        Object[] endpointOrQueryVariablesValues = endpointHandler
                .getVariablesValue(rowManager, Constants.ExternalPostProcessorVariableType.REQUEST_VARIABLES, "driver_pickup_location", resultFuture);
    ...
    public void shouldReturnEndpointQueryVariableValuesForPrimitiveDataFromDescriptorInCaseOfMultipleStreams() {
        when(sourceConfig.getVariables()).thenReturn("customer_id");
        inputProtoClasses = new String[]{"org.raystack.dagger.consumer.TestBookingLogMessage", "org.raystack.dagger.consumer.TestBookingLogMessage"};
    ...
    public void shouldThrowErrorIfInputProtoNotFound() {
        when(sourceConfig.getVariables()).thenReturn("driver_pickup_location");
        inputProtoClasses = new String[]{"org.raystack.dagger.consumer.TestBookingLogMessage1"};
        ...
        assertThrows(NullPointerException.class,
                () -> endpointHandler.getVariablesValue(rowManager, Constants.ExternalPostProcessorVariableType.REQUEST_VARIABLES, sourceConfig.getVariables(), resultFuture));
