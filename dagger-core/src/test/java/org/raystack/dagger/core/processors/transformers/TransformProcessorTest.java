...
import static org.raystack.dagger.core.metrics.telemetry.TelemetryTypes.PRE_PROCESSOR_TYPE;
...
public class TransformProcessorTest extends DaggerContextTestBase {
    ...
    public void shouldThrowExceptionInCaseOfWrongConstructorTypeSupported() {
        ...
        transformationArguments.put("keyField", "keystore");
        transfromConfigs = new ArrayList<>();
        transfromConfigs.add(new TransformConfig("org.raystack.dagger.core.processors.transformers.TransformProcessor", transformationArguments));

        TransformProcessor transformProcessor = new TransformProcessor(transfromConfigs, daggerContext);
        RuntimeException exception = assertThrows(RuntimeException.class, () -> transformProcessor.process(streamInfo));
        assertEquals("org.raystack.dagger.core.processors.transformers.TransformProcessor.<init>(java.util.Map, [Ljava.lang.String;, org.raystack.dagger.common.core.DaggerContext)", exception.getMessage());
    }
    ...
    public void shouldProcessTwoPostTransformers() {
        ...
        transfromConfigs = new ArrayList<>();
        transfromConfigs.add(new TransformConfig("org.raystack.dagger.core.processors.transformers.MockTransformer", new HashMap<String, Object>() {{
    ...
    public void shouldPopulateDefaultArguments() {
        TransformConfig config = new TransformConfig("org.raystack.TestProcessor", new HashMap<String, Object>() {{
        ...
        assertEquals("org.raystack.TestProcessor", processor.transformConfigs.get(0).getTransformationClass());
