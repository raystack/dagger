...
public class PgAsyncConnectorTest {
    ...
    public void setUp() {
        ...
        inputProtoClasses = new String[]{"org.raystack.consumer.TestLogMessage"};
        ...
        when(schemaConfig.getOutputProtoClassName()).thenReturn("org.raystack.consumer.TestBookingLogMessage");
    ...
    private PgSourceConfigBuilder getPgSourceConfigBuilder() {
        return new PgSourceConfigBuilder()
                ...
                .setDatabase("db")
                .setType("org.raystack.consumer.TestFlattenLogMessage")
                .setCapacity("30")
    ...
    public void shouldFetchDescriptorInInvoke() throws Exception {
        ...
        verify(stencilClient, times(1)).get("org.raystack.consumer.TestFlattenLogMessage");
    }
    ...
    public void shouldCompleteExceptionallyIfDescriptorNotFound() throws Exception {
        ...
        assertEquals("No Descriptor found for class org.raystack.consumer.TestLogMessage", reportFatalExceptionCaptor.getValue().getMessage());
        ...
        assertEquals("No Descriptor found for class org.raystack.consumer.TestLogMessage", decriptorNotFoundCaptor.getValue().getMessage());
    }
    ...
    public void shouldEnrichWhenQueryVariableFieldIsNullOrRemovedButNotRequiredInPattern() throws Exception {
        ...
        verify(resultFuture, times(1)).completeExceptionally(invalidConfigCaptor.capture());
        assertEquals("No Descriptor found for class org.raystack.consumer.TestFlattenLogMessage",
                invalidConfigCaptor.getValue().getMessage());
    ...
    public void shouldGetDescriptorFromOutputProtoIfTypeNotGiven() throws Exception {
        ...
        pgAsyncConnector.open(configuration);
        pgAsyncConnector.asyncInvoke(streamRow, resultFuture);
        verify(stencilClient, times(1)).get("org.raystack.consumer.TestBookingLogMessage");
    }
