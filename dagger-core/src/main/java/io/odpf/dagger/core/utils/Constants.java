...
public class Constants {
    ...
    public static final String STREAM_SOURCE_DETAILS_SOURCE_NAME_KAFKA = "KAFKA";
    public static final String STREAM_SOURCE_DETAILS_SOURCE_NAME_PARQUET = "PARQUET";
    public static final String STREAM_SOURCE_PARQUET_FILE_PATHS_KEY = "SOURCE_PARQUET_FILE_PATHS";
    public static final String STREAM_SOURCE_PARQUET_BILLING_PROJECT_KEY = "SOURCE_PARQUET_BILLING_PROJECT";
    ...
    public static final String STREAM_SOURCE_PARQUET_CHRONOLOGICAL_FILE_PATH_REGEX = "SOURCE_PARQUET_CHRONOLOGICAL_FILE_PATH_REGEX";
