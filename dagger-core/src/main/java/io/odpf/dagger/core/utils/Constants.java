...
public class Constants {
    ...
    public static final String PROCESSOR_LONGBOW_GCP_INSTANCE_ID_DEFAULT = "godata-id-daggers";
    public static final String PROCESSOR_LONGBOW_GCP_TABLE_ID_KEY = "PROCESSOR_LONGBOW_GCP_TABLE_ID_KEY";
    ...
    public static final long FLINK_WATERMARK_INTERVAL_DELAY_MS_DEFAULT = 10000;
    public static final String FLINK_WATERMARK_INTERVAL_DELAY_MS_KEY = "FLINK_WATERMARK_INTERVAL_DELAY_MS";
