...
public class Constants {
    ...
    public static final String STREAM_INPUT_JSON_ROW_TIME_FIELD_NAME_KEY = "INPUT_JSON_ROW_TIME_FIELD";
    public static final String STREAM_INPUT_JSON_SCHEMA_KEY = "INPUT_JSON_SCHEMA";
