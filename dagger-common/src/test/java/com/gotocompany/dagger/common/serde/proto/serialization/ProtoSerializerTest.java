package org.raystack.dagger.common.serde.proto.serialization;
...
import org.raystack.dagger.common.exceptions.serde.DaggerSerializationException;
import org.raystack.dagger.common.exceptions.serde.InvalidColumnMappingException;
import org.raystack.dagger.common.exceptions.serde.InvalidDataTypeException;
import org.raystack.dagger.consumer.*;
...
public class ProtoSerializerTest {
    ...
    public void shouldSerializeKeyForProto() throws InvalidProtocolBufferException {
        ...
        String outputProtoKey = "org.raystack.dagger.consumer.TestSerDeLogKey";
        String outputProtoMessage = "org.raystack.dagger.consumer.TestSerDeLogMessage";
    ...
    public void shouldSerializeDataForOneFieldInNestedProtoWhenMappedFromQuery() throws InvalidProtocolBufferException {
        ...
        String outputProtoKey = "org.raystack.dagger.consumer.TestEnrichedBookingLogMessage";
        String outputProtoMessage = "org.raystack.dagger.consumer.TestEnrichedBookingLogMessage";
        ProtoSerializer serializer = new ProtoSerializer(outputProtoKey, outputProtoMessage, columnNames, stencilClientOrchestrator);
    ...
    public void shouldSerializeDataForMultipleFieldsInDifferentNestedProtoWhenMappedFromQuery() throws InvalidProtocolBufferException {
        ...
        String outputProtoKey = "org.raystack.dagger.consumer.TestBookingLogKey";
        String outputProtoMessage = "org.raystack.dagger.consumer.TestBookingLogMessage";
        ProtoSerializer serializer = new ProtoSerializer(outputProtoKey, outputProtoMessage, columnNames, stencilClientOrchestrator);
    ...
    public void shouldThrowExceptionWhenColumnDoesNotExists() {
        ...
        assertEquals("column invalid doesn't exists in the proto of org.raystack.dagger.consumer.TestLocation",
    ...
    public void shouldReturnNullKeyWhenOnlyMessageProtoProvided() {
        ...
        String protoMessage = "org.raystack.dagger.consumer.TestSerDeLogMessage";
