...
public class RepeatedPrimitiveTypeHandlerTest {
    ...
    public void shouldReturnTrueIfRepeatedPrimitiveFieldDescriptorIsPassed() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(repeatedFieldDescriptor);

        assertTrue(repeatedPrimitiveTypeHandler.canHandle());
    }
    ...
    public void shouldReturnFalseIfRepeatedMessageFieldDescriptorIsPassed() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(repeatedMessageFieldDescriptor);

        assertFalse(repeatedPrimitiveTypeHandler.canHandle());
    }
    ...
    public void shouldReturnFalseIfRepeatedEnumFieldDescriptorIsPassed() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(repeatedEnumFieldDescriptor);
    ...
    public void shouldReturnFalseIfFieldDescriptorOtherThanTypeIsPassed() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(otherFieldDescriptor);
    ...
    public void shouldReturnSameBuilderWithoutSettingFieldIfCannotHandle() {
        ...
        DynamicMessage.Builder returnedBuilder = repeatedPrimitiveTypeHandler.transformToProtoBuilder(builder, "123");
    ...
    public void shouldReturnSameBuilderWithoutSettingFieldIfNullFieldIsPassed() {
        ...
        DynamicMessage.Builder returnedBuilder = repeatedPrimitiveTypeHandler.transformToProtoBuilder(builder, null);
    ...
    public void shouldSetEmptyListInBuilderIfEmptyListIfPassed() {
        ...
        DynamicMessage.Builder returnedBuilder = repeatedPrimitiveTypeHandler.transformToProtoBuilder(builder, inputValues);
    ...
    public void shouldSetFieldPassedInTheBuilderAsArray() {
        ...
        DynamicMessage.Builder returnedBuilder = repeatedPrimitiveTypeHandler.transformToProtoBuilder(builder, inputValues.toArray());
        List<String> outputValues = (List<String>) returnedBuilder.getField(repeatedFieldDescriptor);
        assertEquals(asList("test1", "test2"), outputValues);
    }
    ...
    public void shouldReturnArrayOfObjectsWithTypeSameAsFieldDescriptorForPostProcessorTransform() {
        ...
        List<Object> outputValues = (List<Object>) repeatedPrimitiveTypeHandler.transformFromPostProcessor(inputValues);
    ...
    public void shouldReturnEmptyArrayOfObjectsIfNullPassedForPostProcessorTransform() {
        ...
        List<Object> outputValues = (List<Object>) repeatedPrimitiveTypeHandler.transformFromPostProcessor(null);
    ...
    public void shouldThrowExceptionIfFieldDesciptorTypeNotSupportedForPostProcessorTransform() {
        ...
        DataTypeNotSupportedException exception = Assert.assertThrows(DataTypeNotSupportedException.class,
                () -> repeatedPrimitiveTypeHandler.transformFromPostProcessor(inputValues));
    ...
    public void shouldThrowInvalidDataTypeExceptionInCaseOfTypeMismatchForPostProcessorTransform() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(repeatedFloatFieldDescriptor);
        ArrayList<String> inputValues = new ArrayList<>();
        inputValues.add("test");
    ...
    public void shouldReturnAllFieldsInAListOfObjectsIfMultipleFieldsPassedWithSameTypeAsFieldDescriptorForKafkaTransform() throws InvalidProtocolBufferException {
        ...
        String[] outputValues = (String[]) repeatedPrimitiveTypeHandler.transformFromProto(dynamicMessage.getField(repeatedFieldDescriptor));
    ...
    public void shouldThrowUnsupportedDataTypeExceptionInCaseOfInCaseOfEnumForKafkaTransform() {
        ...
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(fieldDescriptor);
        DataTypeNotSupportedException exception = Assert.assertThrows(DataTypeNotSupportedException.class,
                () -> repeatedPrimitiveTypeHandler.transformFromProto("CREATED"));
    ...
    public void shouldReturnTypeInformation() {
        Descriptors.FieldDescriptor repeatedFieldDescriptor = TestBookingLogMessage.getDescriptor().findFieldByName("meta_array");
        RepeatedPrimitiveTypeHandler repeatedPrimitiveTypeHandler = new RepeatedPrimitiveTypeHandler(repeatedFieldDescriptor);
        TypeInformation actualTypeInformation = repeatedPrimitiveTypeHandler.getTypeInformation();
    ...
    public void shouldConvertRepeatedRowDataToJsonString() {
        ...
        Object value = new RepeatedPrimitiveTypeHandler(repeatedFieldDescriptor).transformToJson(inputValues);
