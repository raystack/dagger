...
public class ProtoSerializerHelper implements Serializable {
    ...
    public ProtoSerializerHelper(String keyProtoClassName, String[] columnNames, StencilClientOrchestrator stencilClientOrchestrator, String messageProtoClassName) {
