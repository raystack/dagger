    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/raystack/dagger/edit/master/docs/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/raystack/dagger',
        ...
        links: [
          {
            ...
            items: [
              ...
              { label: 'Stencil', href: 'https://github.com/raystack/stencil' },
            ],
          },
          {
            title: 'Resources',
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'GitHub', href: 'https://github.com/raystack/dagger' }
            ],
          },
        ],
      },
      ...
      announcementBar: {
        id: 'star-repo',
        content: '⭐️ If you like Dagger, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/raystack/dagger">GitHub</a>! ⭐',
        backgroundColor: '#222',
        textColor: '#eee',
        isCloseable: true,
      },
