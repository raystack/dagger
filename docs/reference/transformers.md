...
* Contract: 
  * After Selecting columns by SQL, you have to reselect by an internal source. Following transformation arguments can be passed:
...
* Contract: 
  * After Selecting columns by SQL, you have to reselect by an internal source. Following transformation arguments can be passed:
    * `maskColumns`: The fields that need to be encrypted/masked.
* Functionality:
